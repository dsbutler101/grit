...
output "ssh_key_pem_name" {
  value       = module.prod-module.ssh_key_pem_name
...
output "ssh_key_pem" {
  value       = module.prod-module.ssh_key_pem
  description = "The pem file with SSH key for access to the autoscaling group instances"
  sensitive   = true
}
...
output "fleeting_service_account_access_key_id" {
  value       = module.prod-module.fleeting_service_account_access_key_id
...
output "fleeting_service_account_secret_access_key" {
  value       = module.prod-module.fleeting_service_account_secret_access_key
...
output "autoscaling_group_names" {
  value = module.prod-module.autoscaling_group_names
}