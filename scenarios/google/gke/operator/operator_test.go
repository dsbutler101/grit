...
var defaultModuleVars = map[string]any{
	...
	"runner_description":  "GitLab Runner for CI/CD pipelines",
	...
	"pod_spec_patches":            []string{},
	"operator_version":            "v1.5.0",
	"log_level":                   "info",
	"listen_address":              "[::]:9252",
	"override_operator_manifests": "file://testdata/override.yaml",
}
...
func TestGKE(t *testing.T) {
	expectedModules := []string{
		...
		"module.runner.terraform_data.config_template",
		"module.runner.terraform_data.token_secret",
		...
		"module.runner.kubectl_manifest.token_secret",
		...
		"module.runner.kubectl_manifest.envvars[0]",
		"module.runner.kubectl_manifest.manifest",
		"module.runner.terraform_data.envvars",
