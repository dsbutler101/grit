...
func TestAWSInternalEC2Fleeting(t *testing.T) {
	...
	baseExpectedModules := []string{
		...
		"module.test-module.module.ec2-instance-group[0].module.common.aws_internet_gateway.internet-access",
		...
		"module.test-module.module.ec2-instance-group[0].module.common.aws_route.internet-route",
		"module.test-module.module.ec2-instance-group[0].module.common.aws_security_group.jobs-security-group",
		"module.test-module.module.ec2-instance-group[0].module.common.aws_subnet.jobs-vpc-subnet",
		"module.test-module.module.ec2-instance-group[0].module.common.aws_vpc.jobs-vpc",
		"module.test-module.module.ec2-instance-group[0].module.common.data.aws_route_table.jobs-route-table",
		...
		"module.test-module.module.ec2-managers[0].aws_internet_gateway.igw",
		"module.test-module.module.ec2-managers[0].aws_route_table.rtb_public",
		"module.test-module.module.ec2-managers[0].aws_route_table_association.rta_subnet_public",
		"module.test-module.module.ec2-managers[0].aws_security_group.sg_22",
		"module.test-module.module.ec2-managers[0].aws_subnet.subnet_public",
		"module.test-module.module.ec2-managers[0].aws_vpc.vpc",
