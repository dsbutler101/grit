...
output "ssh_key_pem_name" {
  value       = module.test-module.ssh_key_pem_name
...
output "ssh_key_pem" {
  value       = module.test-module.ssh_key_pem
  description = "The pem file with SSH key for access to the autoscaling group instances"
  sensitive   = true
}
...
output "fleeting_service_account_access_key_id" {
  value       = module.test-module.fleeting_service_account_access_key_id
...
output "fleeting_service_account_secret_access_key" {
  value       = module.test-module.fleeting_service_account_secret_access_key
...
output "autoscaling_group_names" {
  value = module.test-module.autoscaling_group_names
}
